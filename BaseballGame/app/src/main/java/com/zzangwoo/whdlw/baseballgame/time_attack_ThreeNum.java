...
public class time_attack_ThreeNum extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_time_attack__three_num);

        Button threenum_stageButton1 = (Button) findViewById(R.id.threenum_stageButton1);
        Button threenum_stageButton2 = (Button) findViewById(R.id.threenum_stageButton2);
        Button threenum_stageButton3 = (Button) findViewById(R.id.threenum_stageButton3);
        Button threenum_stageButton4 = (Button) findViewById(R.id.threenum_stageButton4);
        Button threenum_stageButton5 = (Button) findViewById(R.id.threenum_stageButton5);
        Button threenum_stageButton6 = (Button) findViewById(R.id.threenum_stageButton6);
        Button threenum_stageButton7 = (Button) findViewById(R.id.threenum_stageButton7);
        Button threenum_stageButton8 = (Button) findViewById(R.id.threenum_stageButton8);
        Button threenum_stageButton9 = (Button) findViewById(R.id.threenum_stageButton9);

        Button time_attack_three_homeButton = (Button) findViewById(R.id.time_attack_three_homeButton);
        Button time_attack_three_preButton = (Button) findViewById(R.id.time_attack_three_preButton);

        threenum_stageButton1.setOnClickListener(this);
        threenum_stageButton2.setOnClickListener(this);
        threenum_stageButton3.setOnClickListener(this);
        threenum_stageButton4.setOnClickListener(this);
        threenum_stageButton5.setOnClickListener(this);
        threenum_stageButton6.setOnClickListener(this);
        threenum_stageButton7.setOnClickListener(this);
        threenum_stageButton8.setOnClickListener(this);
        threenum_stageButton9.setOnClickListener(this);

        threenum_stageButton1.setText(s1);
        threenum_stageButton2.setText(s2);
        threenum_stageButton3.setText(s3);
        threenum_stageButton4.setText(s4);
        threenum_stageButton5.setText(s5);
        threenum_stageButton6.setText(s6);
        threenum_stageButton7.setText(s7);
        threenum_stageButton8.setText(s8);
        threenum_stageButton9.setText(s9);
        ...
        stage1 = pref.getInt("game3_1",0); // 클리어 했으면 1전달 안했으면 걍 0
        stage2 = pref.getInt("game3_2",0);
        stage3 = pref.getInt("game3_3",0);
        stage4 = pref.getInt("game3_4",0);
        stage5 = pref.getInt("game3_5",0);
        stage6 = pref.getInt("game3_6",0);
        stage7 = pref.getInt("game3_7",0);
        stage8 = pref.getInt("game3_8",0);
        stage9 = pref.getInt("game3_9",0);
        //****************************************************************************************************************//

        if(stage1 == 1){
            threenum_stageButton1.setText(span1);
        }
        if(stage2 == 1){
            threenum_stageButton2.setText(span2);
        }
        if(stage3 == 1){
            threenum_stageButton3.setText(span3);
        }
        if(stage4 == 1){
            threenum_stageButton4.setText(span4);
        }
        if(stage5 == 1){
            threenum_stageButton5.setText(span5);
        }
        if(stage6 == 1){
            threenum_stageButton6.setText(span6);
        }
        if(stage7 == 1){
            threenum_stageButton7.setText(span7);
        }
        if(stage8 == 1){
            threenum_stageButton8.setText(span8);
        }
        if(stage9 == 1){
            threenum_stageButton9.setText(span9);
        }
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////

        ///////////////////////////////// 홈으로 버튼 클릭 /////////////////////////////////////////////////////
        time_attack_three_homeButton.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        ///////////////////////////////// 이전으로 버튼 클릭 /////////////////////////////////////////////////////
        time_attack_three_preButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ///////////////////////////맨 처음 화면으로 넘어가기 위한 코드////////////////////////////////////
    ...
    public void onClick(View v){
        switch(v.getId()){
            case R.id.threenum_stageButton1:
                Intent intent1 = new Intent(getApplicationContext(), time_attack_ThreeGame.class);
                intent1.putExtra("time",6000); // 타임어택 시간 (60초 -> 1분)
                intent1.putExtra("stage",1); // 스테이지 고유 이름, 값
                startActivity(intent1);
                break;

            case R.id.threenum_stageButton2:
                Intent intent2 = new Intent(getApplicationContext(), time_attack_ThreeGame.class);
                intent2.putExtra("time",5000);
                intent2.putExtra("stage",2);
                startActivity(intent2);
                break;

            case R.id.threenum_stageButton3:
                Intent intent3 = new Intent(getApplicationContext(), time_attack_ThreeGame.class);
                intent3.putExtra("time",4500);
                intent3.putExtra("stage",3);
                startActivity(intent3);
                break;

            case R.id.threenum_stageButton4:
                Intent intent4 = new Intent(getApplicationContext(), time_attack_ThreeGame.class);
                intent4.putExtra("time",4000);
                intent4.putExtra("stage",4);
                startActivity(intent4);
                break;

            case R.id.threenum_stageButton5:
                Intent intent5 = new Intent(getApplicationContext(), time_attack_ThreeGame.class);
                intent5.putExtra("time",3500);
                intent5.putExtra("stage",5);
                startActivity(intent5);
                break;

            case R.id.threenum_stageButton6:
                Intent intent6 = new Intent(getApplicationContext(), time_attack_ThreeGame.class);
                intent6.putExtra("time",3000);
                intent6.putExtra("stage",6);
                startActivity(intent6);
                break;

            case R.id.threenum_stageButton7:
                Intent intent7 = new Intent(getApplicationContext(), time_attack_ThreeGame.class);
                intent7.putExtra("time",2500);
                intent7.putExtra("stage",7);
                startActivity(intent7);
                break;

            case R.id.threenum_stageButton8:
                Intent intent8 = new Intent(getApplicationContext(), time_attack_ThreeGame.class);
                intent8.putExtra("time",2000);
                intent8.putExtra("stage",8);
                startActivity(intent8);
                break;

            case R.id.threenum_stageButton9:
                Intent intent9 = new Intent(getApplicationContext(), time_attack_ThreeGame.class);
                intent9.putExtra("time",1500);
