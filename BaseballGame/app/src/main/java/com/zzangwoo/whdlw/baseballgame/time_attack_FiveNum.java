...
public class time_attack_FiveNum extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_time_attack__five_num);

        Button fivenum_stageButton1 = (Button) findViewById(R.id.fivenum_stageButton1);
        Button fivenum_stageButton2 = (Button) findViewById(R.id.fivenum_stageButton2);
        Button fivenum_stageButton3 = (Button) findViewById(R.id.fivenum_stageButton3);
        Button fivenum_stageButton4 = (Button) findViewById(R.id.fivenum_stageButton4);
        Button fivenum_stageButton5 = (Button) findViewById(R.id.fivenum_stageButton5);
        Button fivenum_stageButton6 = (Button) findViewById(R.id.fivenum_stageButton6);
        Button fivenum_stageButton7 = (Button) findViewById(R.id.fivenum_stageButton7);
        Button fivenum_stageButton8 = (Button) findViewById(R.id.fivenum_stageButton8);
        Button fivenum_stageButton9 = (Button) findViewById(R.id.fivenum_stageButton9);

        Button time_attack_five_homeButton = (Button) findViewById(R.id.time_attack_five_homeButton);
        Button time_attack_five_preButton = (Button) findViewById(R.id.time_attack_five_preButton);

        fivenum_stageButton1.setOnClickListener(this);
        fivenum_stageButton2.setOnClickListener(this);
        fivenum_stageButton3.setOnClickListener(this);
        fivenum_stageButton4.setOnClickListener(this);
        fivenum_stageButton5.setOnClickListener(this);
        fivenum_stageButton6.setOnClickListener(this);
        fivenum_stageButton7.setOnClickListener(this);
        fivenum_stageButton8.setOnClickListener(this);
        fivenum_stageButton9.setOnClickListener(this);

        fivenum_stageButton1.setText(s1);
        fivenum_stageButton2.setText(s2);
        fivenum_stageButton3.setText(s3);
        fivenum_stageButton4.setText(s4);
        fivenum_stageButton5.setText(s5);
        fivenum_stageButton6.setText(s6);
        fivenum_stageButton7.setText(s7);
        fivenum_stageButton8.setText(s8);
        fivenum_stageButton9.setText(s9);
        ...
        stage1 = pref.getInt("game5_1",0); // 클리어 했으면 1전달 안했으면 걍 0
        stage2 = pref.getInt("game5_2",0);
        stage3 = pref.getInt("game5_3",0);
        stage4 = pref.getInt("game5_4",0);
        stage5 = pref.getInt("game5_5",0);
        stage6 = pref.getInt("game5_6",0);
        stage7 = pref.getInt("game5_7",0);
        stage8 = pref.getInt("game5_8",0);
        stage9 = pref.getInt("game5_9",0);
        //****************************************************************************************************************//

        if(stage1 == 1){
            fivenum_stageButton1.setText(span1);
        }
        if(stage2 == 1){
            fivenum_stageButton2.setText(span2);
        }
        if(stage3 == 1){
            fivenum_stageButton3.setText(span3);
        }
        if(stage4 == 1){
            fivenum_stageButton4.setText(span4);
        }
        if(stage5 == 1){
            fivenum_stageButton5.setText(span5);
        }
        if(stage6 == 1){
            fivenum_stageButton6.setText(span6);
        }
        if(stage7 == 1){
            fivenum_stageButton7.setText(span7);
        }
        if(stage8 == 1){
            fivenum_stageButton8.setText(span8);
        }
        if(stage9 == 1){
            fivenum_stageButton9.setText(span9);
        }
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////

        ///////////////////////////////// 홈으로 버튼 클릭 /////////////////////////////////////////////////////
        time_attack_five_homeButton.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        ///////////////////////////////// 이전으로 버튼 클릭 /////////////////////////////////////////////////////
        time_attack_five_preButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ///////////////////////////맨 처음 화면으로 넘어가기 위한 코드////////////////////////////////////
    ...
    public void onClick(View v) {
        switch(v.getId()){
            case R.id.fivenum_stageButton1:
                Intent intent1 = new Intent(getApplicationContext(), time_attack_FiveGame.class);
                intent1.putExtra("time",24000); // 타임어택 시간 (60초 -> 1분)
                intent1.putExtra("stage",1); // 스테이지 고유 이름, 값
                startActivity(intent1);
                break;

            case R.id.fivenum_stageButton2:
                Intent intent2 = new Intent(getApplicationContext(), time_attack_FiveGame.class);
                intent2.putExtra("time",22000);
                intent2.putExtra("stage",2);
                startActivity(intent2);
                break;

            case R.id.fivenum_stageButton3:
                Intent intent3 = new Intent(getApplicationContext(), time_attack_FiveGame.class);
                intent3.putExtra("time",20000);
                intent3.putExtra("stage",3);
                startActivity(intent3);
                break;

            case R.id.fivenum_stageButton4:
                Intent intent4 = new Intent(getApplicationContext(), time_attack_FiveGame.class);
                intent4.putExtra("time",18000);
                intent4.putExtra("stage",4);
                startActivity(intent4);
                break;

            case R.id.fivenum_stageButton5:
                Intent intent5 = new Intent(getApplicationContext(), time_attack_FiveGame.class);
                intent5.putExtra("time",15000);
                intent5.putExtra("stage",5);
                startActivity(intent5);
                break;

            case R.id.fivenum_stageButton6:
                Intent intent6 = new Intent(getApplicationContext(), time_attack_FiveGame.class);
                intent6.putExtra("time",12000);
                intent6.putExtra("stage",6);
                startActivity(intent6);
                break;

            case R.id.fivenum_stageButton7:
                Intent intent7 = new Intent(getApplicationContext(), time_attack_FiveGame.class);
                intent7.putExtra("time",9000);
                intent7.putExtra("stage",7);
                startActivity(intent7);
                break;

            case R.id.fivenum_stageButton8:
                Intent intent8 = new Intent(getApplicationContext(), time_attack_FiveGame.class);
                intent8.putExtra("time",8000);
                intent8.putExtra("stage",8);
                startActivity(intent8);
                break;

            case R.id.fivenum_stageButton9:
                Intent intent9 = new Intent(getApplicationContext(), time_attack_FiveGame.class);
                intent9.putExtra("time",6000);
